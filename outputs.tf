...
output "organization_principal_set_id" {
  ...
  value       = "principalSet://iam.googleapis.com/${google_iam_workload_identity_pool.github.id}/attribute.repository_owner/${var.github_organization}"
}
...
output "repository_principal_set_id_prefix" {
  ...
  value       = "principalSet://iam.googleapis.com/${google_iam_workload_identity_pool.github.id}/attribute.repository/${var.github_organization}"
}
